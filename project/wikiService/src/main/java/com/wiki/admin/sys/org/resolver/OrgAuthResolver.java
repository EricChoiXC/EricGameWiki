 ...
 * 本 resolver 以权限码作为接口标识、authId 作为文档 ID，校验通过后记录可追踪鉴权审计日志。
 *
 * @author Eric
 * @date 2026/9/8
 */
...
public class OrgAuthResolver {
    ...
    /**
     * 要求当前用户具备角色管理权限，并针对指定文档 ID 做接口级鉴权。
     *
     * @param authId 文档 ID（角色ID）；新建场景可为 null
     */
    public void requireManage(String authId) {
        ...
        log.info("[鉴权] 角色管理操作放行 userId={} 接口={} 文档ID={}",
                userId, OrgConstants.PERMISSION_ROLE, authId);
    }
