...
>
> **本文档为 wiki 模块概要文档**，提供表结构、页面、权限、业务流程的概览。
> 正式设计文档已拆分至 `docs/admin/wiki/` 目录下，实现前请以正式子文档为准：
> - [wiki业务逻辑.md](wiki/wiki业务逻辑.md) — 业务流程、数据项三类型、双层鉴权、导入导出流程
> - [wiki技术方案.md](wiki/wiki技术方案.md) — 动态建表引擎、元数据驱动 DDL、通用动态查询层、导入导出批处理架构
> - [wikiAPI接口设计文档.md](wiki/wikiAPI接口设计文档.md) — 项目/数据项/数据明细/wiki 页面维护四组接口
> - [wiki数据库设计.md](wiki/wiki数据库设计.md) — 三张元数据表 + 动态表结构模板 + 索引策略
> - [wiki开发任务清单.md](wiki/wiki开发任务清单.md) — 第一/二/三期代码开发任务，含验收标准与文档同步约束
>
> 冲突处理：业务流程以 [wiki业务逻辑.md](wiki/wiki业务逻辑.md) 为准，表结构以 [wiki数据库设计.md](wiki/wiki数据库设计.md) 为准，
> 接口以 [wikiAPI接口设计文档.md](wiki/wikiAPI接口设计文档.md) 为准；本文档与正式子文档冲突时以正式子文档为准。
